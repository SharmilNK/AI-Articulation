...
def build_document(digest: dict, today_str: str) -> str:
    ...
    f_run = footer_p.add_run(
        "Generated by AI-Articulation | Sources: Lenny's Newsletter, Spill the GPTea, "
        "Intuitive Autonomy, Enterprise AI Executive, Bridge by Adi Agrawal, "
        "Tomorrow Toolbox, Maven, Conventional Commits"
    )
